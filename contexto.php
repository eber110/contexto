<?php 
	...
	function contar($elementoAcontar,$baseDato){
		$minuscula = strtolower($elementoAcontar);//todas las palabras se formatean a minusculas
	...
	//en este algoritmo se verifica cuantas palabras coincide con alguna palabra de la base de datos y se 
	//contabiliza para tener un porcentaje de cada base de datos.
